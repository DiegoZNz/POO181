...
class diego:
    def __init__(self,nom,app,apm,añn,carr):
        self.__nombre=nom
    ...
    def generarMat(self):
        if self.__nombre=='' or self.__apellidoP=='' or self.__apellidoM=='' or self.__añoNacimiento==0 or self.__carrera =='':
